  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage    : '/Scripts/plugin/progressBar/images/percentImage.png',			// boxImage : image around the progress bar
			barImage    : '/Scripts/plugin/progressBar/images/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
